...
|===
 ...
 |dlrm_v4_hstu |adam |opt_base_learning_rate |unconstrained |dense target (post-warmup) learning rate; the warmup ramps to this value and then holds it, there is no decay |link:https://github.com/mlcommons/training/blob/master/recommendation/generative_recommenders/dlrm_v4/train/gin/yambda_5b.gin[reference code] |v6.1
