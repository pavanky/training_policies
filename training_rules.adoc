...
|===
 ...
 |dlrm_v4_hstu |adam |opt_base_learning_rate |[0.5 * 1e-6 * (global_batch_size / 8192), 1.5 * 1e-6 * (global_batch_size / 8192)] |dense target (post-warmup) learning rate; the warmup ramps to this value and then holds it, there is no decay. The reference convergence points are generated at the midpoint of this range, 1e-6 * (global_batch_size / 8192) |link:https://github.com/mlcommons/training/blob/master/recommendation/generative_recommenders/dlrm_v4/train/gin/yambda_5b.gin[reference code] |v6.1
 ...
 |dlrm_v4_hstu |adam |hstu_attn_num_layers |3 |number of HSTU attention layers; part of the model definition and may not be changed in the closed division |link:https://github.com/mlcommons/training/blob/master/recommendation/generative_recommenders/dlrm_v4/train/gin/yambda_5b.gin[reference code] |v6.1
 |dlrm_v4_hstu |adam |history_length |4086 |user interaction history length; part of the model definition and may not be changed in the closed division |link:https://github.com/mlcommons/training/blob/master/recommendation/generative_recommenders/dlrm_v4/train/gin/yambda_5b.gin[reference code] |v6.1
